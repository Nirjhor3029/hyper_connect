...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.visaApplication.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.visa-applications.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visa_type') ? 'is-invalid' : '' }}" type="text" name="visa_type" id="visa_type" value="{{ old('visa_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_stage') ? 'is-invalid' : '' }}" type="text" name="current_stage" id="current_stage" value="{{ old('current_stage', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('issued_at') ? 'is-invalid' : '' }}" type="text" name="issued_at" id="issued_at" value="{{ old('issued_at') }}">
