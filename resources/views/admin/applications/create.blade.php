    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.applications.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('sub_agent') ? 'is-invalid' : '' }}" name="sub_agent_id" id="sub_agent_id">
                    @foreach($sub_agents as $id => $entry)
                        <option value="{{ $id }}" {{ old('sub_agent_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('intake_term') ? 'is-invalid' : '' }}" type="text" name="intake_term" id="intake_term" value="{{ old('intake_term', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('intake_year') ? 'is-invalid' : '' }}" type="number" name="intake_year" id="intake_year" value="{{ old('intake_year', '') }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_fast_track') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_fast_track" id="is_fast_track" value="1" {{ old('is_fast_track', 0) == 1 || old('is_fast_track') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('needs_interview') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="needs_interview" id="needs_interview" value="1" {{ old('needs_interview', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('interview_date') ? 'is-invalid' : '' }}" type="text" name="interview_date" id="interview_date" value="{{ old('interview_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('decision_at') ? 'is-invalid' : '' }}" type="text" name="decision_at" id="decision_at" value="{{ old('decision_at') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('finalized_at') ? 'is-invalid' : '' }}" type="text" name="finalized_at" id="finalized_at" value="{{ old('finalized_at') }}">
