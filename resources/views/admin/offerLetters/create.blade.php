...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.offerLetter.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.offer-letters.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivery_status') ? 'is-invalid' : '' }}" type="text" name="delivery_status" id="delivery_status" value="{{ old('delivery_status', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('visible_to_student') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="visible_to_student" id="visible_to_student" value="1" {{ old('visible_to_student', 0) == 1 ? 'checked' : '' }}>
