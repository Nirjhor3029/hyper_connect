    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.document-types.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('required_for_levels') ? 'is-invalid' : '' }}" name="required_for_levels" id="required_for_levels">{{ old('required_for_levels') }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_translatable') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_translatable" id="is_translatable" value="1" {{ old('is_translatable', 0) == 1 ? 'checked' : '' }}>
