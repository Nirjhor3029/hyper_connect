...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.otherFee.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.other-fees.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('service_fee') ? 'is-invalid' : '' }}" type="number" name="service_fee" id="service_fee" value="{{ old('service_fee', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('admission_fee') ? 'is-invalid' : '' }}" type="number" name="admission_fee" id="admission_fee" value="{{ old('admission_fee', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visa_fee') ? 'is-invalid' : '' }}" type="number" name="visa_fee" id="visa_fee" value="{{ old('visa_fee', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emgs_fee') ? 'is-invalid' : '' }}" type="number" name="emgs_fee" id="emgs_fee" value="{{ old('emgs_fee', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('registration_fee') ? 'is-invalid' : '' }}" type="number" name="registration_fee" id="registration_fee" value="{{ old('registration_fee', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('resource_fee') ? 'is-invalid' : '' }}" type="number" name="resource_fee" id="resource_fee" value="{{ old('resource_fee', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('caution_fee') ? 'is-invalid' : '' }}" type="number" name="caution_fee" id="caution_fee" value="{{ old('caution_fee', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('other_fee_deatils') ? 'is-invalid' : '' }}" name="other_fee_deatils" id="other_fee_deatils">{!! old('other_fee_deatils') !!}</textarea>
