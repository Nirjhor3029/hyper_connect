    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.universities.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="" for="state_id">{{ trans('cruds.university.fields.state') }}</label>
                ...
                <div class="form-group">
                    <label class="" for="city_id">{{ trans('cruds.university.fields.city') }}</label>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('contact_phone') ? 'is-invalid' : '' }}" type="text"
                        name="contact_phone" id="contact_phone" value="{{ old('contact_phone', '') }}" maxlength="20"
                        pattern="^\+?\d*$" title="Only numbers and an optional + sign at the beginning are allowed"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2-tagging {{ $errors->has('tags') ? 'is-invalid' : '' }}"
