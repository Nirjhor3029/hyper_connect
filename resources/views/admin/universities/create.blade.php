        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.universities.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                <label class="required"
                                    for="country_id">{{ trans('cruds.university.fields.country') }}</label>
                                <select class="form-control select2 {{ $errors->has('country') ? 'is-invalid' : '' }}"
                                    name="country_id" id="country_id" required>
                                    @foreach ($countries as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ env('DEFAULT_COUNTRY_FOR_UNIVERSITY') == $entry ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                <label class="required"
                                    for="website">{{ trans('cruds.university.fields.website') }}</label>
                                <input class="form-control {{ $errors->has('website') ? 'is-invalid' : '' }}"
                                    type="url" name="website" id="website" value="{{ old('website', '') }}" required>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input class="form-control {{ $errors->has('university_type') ? 'is-invalid' : '' }}"
                                    type="text" name="university_type" id="university_type"
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.university.fields.university_type_helper') }}</span>
                            </div>

                            {{-- accreditation --}}
                            <div class="form-group col-md-3">
                                <label for="accreditation">{{ trans('cruds.university.fields.accreditation') }}</label>
                                <input class="form-control {{ $errors->has('accreditation') ? 'is-invalid' : '' }}"
                                    type="text" name="accreditation" id="accreditation"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="form-control ckeditor {{ $errors->has('university_details') ? 'is-invalid' : '' }}"
                            name="university_details" id="university_details">{!! old('university_details') !!}</textarea>
                ...
                {{-- <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('logo_url') ? 'is-invalid' : '' }}" type="text"
                        name="logo_url" id="logo_url" value="{{ old('logo_url', '') }}">
                            ...
                            return loader.file
                                .then(function(file) {
                                    return new Promise(function(resolve, reject) {
                                        ...
                                        xhr.open('POST',
                                            '{{ route('admin.universities.storeCKEditorImages') }}',
                                            true);
