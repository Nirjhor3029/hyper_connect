    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.documents.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('translation_status') ? 'is-invalid' : '' }}" type="text" name="translation_status" id="translation_status" value="{{ old('translation_status', '') }}">
