    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.students.update", [$student->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visa_status') ? 'is-invalid' : '' }}" type="text" name="visa_status" id="visa_status" value="{{ old('visa_status', $student->visa_status) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('emergency_contact') ? 'is-invalid' : '' }}" name="emergency_contact" id="emergency_contact">{{ old('emergency_contact', $student->emergency_contact) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('guardian_details') ? 'is-invalid' : '' }}" name="guardian_details" id="guardian_details">{!! old('guardian_details', $student->guardian_details) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('education_background') ? 'is-invalid' : '' }}" name="education_background" id="education_background">{!! old('education_background', $student->education_background) !!}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('scholarship_status') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="scholarship_status" id="scholarship_status" value="1" {{ $student->scholarship_status || old('scholarship_status', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('current_address') ? 'is-invalid' : '' }}" name="current_address" id="current_address">{!! old('current_address', $student->current_address) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('permanent_address') ? 'is-invalid' : '' }}" name="permanent_address" id="permanent_address">{!! old('permanent_address', $student->permanent_address) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('lead_agent') ? 'is-invalid' : '' }}" name="lead_agent_id" id="lead_agent_id">
                    @foreach($lead_agents as $id => $entry)
                        <option value="{{ $id }}" {{ (old('lead_agent_id') ? old('lead_agent_id') : $student->lead_agent->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('handelling_agent') ? 'is-invalid' : '' }}" name="handelling_agent_id" id="handelling_agent_id">
                    @foreach($handelling_agents as $id => $entry)
                        <option value="{{ $id }}" {{ (old('handelling_agent_id') ? old('handelling_agent_id') : $student->handelling_agent->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('course_interesteds') ? 'is-invalid' : '' }}" name="course_interesteds[]" id="course_interesteds" multiple>
                    @foreach($course_interesteds as $id => $course_interested)
                        <option value="{{ $id }}" {{ (in_array($id, old('course_interesteds', [])) || $student->course_interesteds->contains($id)) ? 'selected' : '' }}>{{ $course_interested }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_status') ? 'is-invalid' : '' }}" type="text" name="current_status" id="current_status" value="{{ old('current_status', $student->current_status) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_status') ? 'is-invalid' : '' }}" type="text" name="payment_status" id="payment_status" value="{{ old('payment_status', $student->payment_status) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('academic_details') ? 'is-invalid' : '' }}" name="academic_details" id="academic_details">{!! old('academic_details', $student->academic_details) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('academic_attachments') ? 'is-invalid' : '' }}" name="academic_attachments[]" id="academic_attachments" multiple>
                    @foreach($academic_attachments as $id => $academic_attachment)
                        <option value="{{ $id }}" {{ (in_array($id, old('academic_attachments', [])) || $student->academic_attachments->contains($id)) ? 'selected' : '' }}>{{ $academic_attachment }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('offer_letter_details') ? 'is-invalid' : '' }}" name="offer_letter_details" id="offer_letter_details">{!! old('offer_letter_details', $student->offer_letter_details) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('additional_requirements') ? 'is-invalid' : '' }}" name="additional_requirements" id="additional_requirements">{!! old('additional_requirements', $student->additional_requirements) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('val_status') ? 'is-invalid' : '' }}" type="text" name="val_status" id="val_status" value="{{ old('val_status', $student->val_status) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emgs_status') ? 'is-invalid' : '' }}" type="text" name="emgs_status" id="emgs_status" value="{{ old('emgs_status', $student->emgs_status) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('commission_amount') ? 'is-invalid' : '' }}" type="number" name="commission_amount" id="commission_amount" value="{{ old('commission_amount', $student->commission_amount) }}" step="0.01">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_offer_given_to_student') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_offer_given_to_student" id="is_offer_given_to_student" value="1" {{ $student->is_offer_given_to_student || old('is_offer_given_to_student', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('offer_details') ? 'is-invalid' : '' }}" name="offer_details" id="offer_details">{!! old('offer_details', $student->offer_details) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('enrollement_status') ? 'is-invalid' : '' }}" type="text" name="enrollement_status" id="enrollement_status" value="{{ old('enrollement_status', $student->enrollement_status) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_commission_claimed_from_univeristy') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_commission_claimed_from_univeristy" id="is_commission_claimed_from_univeristy" value="1" {{ $student->is_commission_claimed_from_univeristy || old('is_commission_claimed_from_univeristy', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <label for="chossen_university_id">{{ trans('cruds.student.fields.chossen_university') }}</label>
                <select class="form-control select2 {{ $errors->has('chossen_university') ? 'is-invalid' : '' }}" name="chossen_university_id" id="chossen_university_id">
                    @foreach($chossen_universities as $id => $entry)
                        <option value="{{ $id }}" {{ (old('chossen_university_id') ? old('chossen_university_id') : $student->chossen_university->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('chossen_university'))
                    <div class="invalid-feedback">
                        {{ $errors->first('chossen_university') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.student.fields.chossen_university_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="subject_id">{{ trans('cruds.student.fields.subject') }}</label>
                <select class="form-control select2 {{ $errors->has('subject') ? 'is-invalid' : '' }}" name="subject_id" id="subject_id">
                    @foreach($subjects as $id => $entry)
                        <option value="{{ $id }}" {{ (old('subject_id') ? old('subject_id') : $student->subject->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
