    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.programs.update", [$program->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('university') ? 'is-invalid' : '' }}" name="university_id" id="university_id">
                    @foreach($universities as $id => $entry)
                        <option value="{{ $id }}" {{ (old('university_id') ? old('university_id') : $program->university->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $program->name) }}">
                @if($errors->has('name'))
                    <div class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('short_code') ? 'is-invalid' : '' }}" type="text" name="short_code" id="short_code" value="{{ old('short_code', $program->short_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_of_study') ? 'is-invalid' : '' }}" type="text" name="field_of_study" id="field_of_study" value="{{ old('field_of_study', $program->field_of_study) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('education_type') ? 'is-invalid' : '' }}" type="text" name="education_type" id="education_type" value="{{ old('education_type', $program->education_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level') ? 'is-invalid' : '' }}" type="text" name="level" id="level" value="{{ old('level', $program->level) }}">
                @if($errors->has('level'))
                    <div class="invalid-feedback">
                        {{ $errors->first('level') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_months') ? 'is-invalid' : '' }}" type="text" name="duration_months" id="duration_months" value="{{ old('duration_months', $program->duration_months) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('credit_hours') ? 'is-invalid' : '' }}" type="number" name="credit_hours" id="credit_hours" value="{{ old('credit_hours', $program->credit_hours) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fees') ? 'is-invalid' : '' }}" type="number" name="fees" id="fees" value="{{ old('fees', $program->fees) }}" step="0.01">
                @if($errors->has('fees'))
                    <div class="invalid-feedback">
                        {{ $errors->first('fees') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('fee_breakdown') ? 'is-invalid' : '' }}" name="fee_breakdown" id="fee_breakdown">{!! old('fee_breakdown', $program->fee_breakdown) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('teaching_language') ? 'is-invalid' : '' }}" type="text" name="teaching_language" id="teaching_language" value="{{ old('teaching_language', $program->teaching_language) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('semester_intake_months') ? 'is-invalid' : '' }}" name="semester_intake_months" id="semester_intake_months">{!! old('semester_intake_months', $program->semester_intake_months) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('requirements') ? 'is-invalid' : '' }}" name="requirements" id="requirements">{!! old('requirements', $program->requirements) !!}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_active') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" {{ $program->is_active || old('is_active', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('tags') ? 'is-invalid' : '' }}" name="tags[]" id="tags" multiple>
                    @foreach($tags as $id => $tag)
                        <option value="{{ $id }}" {{ (in_array($id, old('tags', [])) || $program->tags->contains($id)) ? 'selected' : '' }}>{{ $tag }}</option>
                    @endforeach
                </select>
                @if($errors->has('tags'))
                    <div class="invalid-feedback">
