...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.agentCommission.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.agent-commissions.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('source_type') ? 'is-invalid' : '' }}" type="text" name="source_type" id="source_type" value="{{ old('source_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('commission_type') ? 'is-invalid' : '' }}" type="text" name="commission_type" id="commission_type" value="{{ old('commission_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('base_amount') ? 'is-invalid' : '' }}" type="number" name="base_amount" id="base_amount" value="{{ old('base_amount', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payout_method') ? 'is-invalid' : '' }}" type="text" name="payout_method" id="payout_method" value="{{ old('payout_method', '') }}">
