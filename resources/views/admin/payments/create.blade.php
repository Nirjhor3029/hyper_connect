    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.payments.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('receipt_url') ? 'is-invalid' : '' }}" type="text" name="receipt_url" id="receipt_url" value="{{ old('receipt_url', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('invoice_url') ? 'is-invalid' : '' }}" type="text" name="invoice_url" id="invoice_url" value="{{ old('invoice_url', '') }}">
