    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.subjects.update", [$subject->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('university') ? 'is-invalid' : '' }}" name="university_id" id="university_id">
                    @foreach($universities as $id => $entry)
                        <option value="{{ $id }}" {{ (old('university_id') ? old('university_id') : $subject->university->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('course') ? 'is-invalid' : '' }}" name="course_id" id="course_id">
                    @foreach($courses as $id => $entry)
                        <option value="{{ $id }}" {{ (old('course_id') ? old('course_id') : $subject->course->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subject_name') ? 'is-invalid' : '' }}" type="text" name="subject_name" id="subject_name" value="{{ old('subject_name', $subject->subject_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subject_details') ? 'is-invalid' : '' }}" type="text" name="subject_details" id="subject_details" value="{{ old('subject_details', $subject->subject_details) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration') ? 'is-invalid' : '' }}" type="text" name="duration" id="duration" value="{{ old('duration', $subject->duration) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('course_fee') ? 'is-invalid' : '' }}" type="number" name="course_fee" id="course_fee" value="{{ old('course_fee', $subject->course_fee) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('required_fee') ? 'is-invalid' : '' }}" type="number" name="required_fee" id="required_fee" value="{{ old('required_fee', $subject->required_fee) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_fees') ? 'is-invalid' : '' }}" type="number" name="other_fees" id="other_fees" value="{{ old('other_fees', $subject->other_fees) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('eligibility_criterias') ? 'is-invalid' : '' }}" name="eligibility_criterias" id="eligibility_criterias">{!! old('eligibility_criterias', $subject->eligibility_criterias) !!}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('english_requirements') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="english_requirements" id="english_requirements" value="1" {{ $subject->english_requirements || old('english_requirements', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('waiver_program') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="waiver_program" id="waiver_program" value="1" {{ $subject->waiver_program || old('waiver_program', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('waiver_amount') ? 'is-invalid' : '' }}" type="number" name="waiver_amount" id="waiver_amount" value="{{ old('waiver_amount', $subject->waiver_amount) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('waiver_criterias') ? 'is-invalid' : '' }}" name="waiver_criterias" id="waiver_criterias">{!! old('waiver_criterias', $subject->waiver_criterias) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('subject_prerequisits') ? 'is-invalid' : '' }}" name="subject_prerequisits" id="subject_prerequisits">{!! old('subject_prerequisits', $subject->subject_prerequisits) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('commission') ? 'is-invalid' : '' }}" type="number" name="commission" id="commission" value="{{ old('commission', $subject->commission) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('tags') ? 'is-invalid' : '' }}" name="tags[]" id="tags" multiple>
                    @foreach($tags as $id => $tag)
                        <option value="{{ $id }}" {{ (in_array($id, old('tags', [])) || $subject->tags->contains($id)) ? 'selected' : '' }}>{{ $tag }}</option>
                    @endforeach
                </select>
                @if($errors->has('tags'))
                    <div class="invalid-feedback">
