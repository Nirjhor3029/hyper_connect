    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.user-settings.update", [$userSetting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('preferences') ? 'is-invalid' : '' }}" name="preferences" id="preferences">{{ old('preferences', $userSetting->preferences) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('language') ? 'is-invalid' : '' }}" type="text" name="language" id="language" value="{{ old('language', $userSetting->language) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('theme_mode') ? 'is-invalid' : '' }}" type="text" name="theme_mode" id="theme_mode" value="{{ old('theme_mode', $userSetting->theme_mode) }}">
