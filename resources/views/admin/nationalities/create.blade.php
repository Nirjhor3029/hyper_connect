    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.nationalities.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('num_code') ? 'is-invalid' : '' }}" type="number" name="num_code" id="num_code" value="{{ old('num_code', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alpha_2_code') ? 'is-invalid' : '' }}" type="text" name="alpha_2_code" id="alpha_2_code" value="{{ old('alpha_2_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alpha_3_code') ? 'is-invalid' : '' }}" type="text" name="alpha_3_code" id="alpha_3_code" value="{{ old('alpha_3_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nationality_en') ? 'is-invalid' : '' }}" type="text" name="nationality_en" id="nationality_en" value="{{ old('nationality_en', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nationality_bn') ? 'is-invalid' : '' }}" type="text" name="nationality_bn" id="nationality_bn" value="{{ old('nationality_bn', '') }}">
