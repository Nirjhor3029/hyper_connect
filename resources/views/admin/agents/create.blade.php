    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.agents.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('parent_agent') ? 'is-invalid' : '' }}" name="parent_agent_id" id="parent_agent_id">
                    @foreach($parent_agents as $id => $entry)
                        <option value="{{ $id }}" {{ old('parent_agent_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tier') ? 'is-invalid' : '' }}" type="text" name="tier" id="tier" value="{{ old('tier', '') }}">
                @if($errors->has('tier'))
                    <div class="invalid-feedback">
                        {{ $errors->first('tier') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('banking_info') ? 'is-invalid' : '' }}" name="banking_info" id="banking_info">{{ old('banking_info') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('commission_policy') ? 'is-invalid' : '' }}" name="commission_policy" id="commission_policy">{!! old('commission_policy') !!}</textarea>
