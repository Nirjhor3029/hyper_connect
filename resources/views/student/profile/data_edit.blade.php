                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text"
                                   name="name" id="name" value="{{ old('name', $student->name) }}" required>
                            @if($errors->has('name'))
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text"
                                   name="phone" id="phone" value="{{ old('phone', $student->phone) }}" required>
                            @if($errors->has('phone'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('phone') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control {{ $errors->has('gender') ? 'is-invalid' : '' }}" name="gender"
                                ...
                                @foreach(App\Models\Student::GENDER_SELECT as $key => $label)
                                    <option
                                        value="{{ $key }}" {{ old('gender', $student->gender) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select
                                ...
                                @foreach($interested_countries as $id => $interested_country)
                                    <option
                                        value="{{ $id }}" {{ (in_array($id, old('interested_countries', [])) || $student->interested_countries->contains($id)) ? 'selected' : '' }}>{{ $interested_country }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('univertsities') ? 'is-invalid' : '' }}"
                                    name="univertsities[]" id="univertsities" multiple>
                                @foreach($univertsities as $id => $univertsity)
                                    <option
                                        value="{{ $id }}" {{ (in_array($id, old('univertsities', [])) || $student->univertsities->contains($id)) ? 'selected' : '' }}>{{ $univertsity }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('subjects') ? 'is-invalid' : '' }}"
                                    name="subjects[]" id="subjects" multiple>
                                @foreach($subjects as $id => $subject)
                                    <option
                                        value="{{ $id }}" {{ (in_array($id, old('subjects', [])) || $student->subjects->contains($id)) ? 'selected' : '' }}>{{ $subject }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('programs') ? 'is-invalid' : '' }}"
                                    name="programs[]" id="programs" multiple>
                                @foreach($programs as $id => $program)
                                    <option
                                        value="{{ $id }}" {{ (in_array($id, old('programs', [])) || $student->programs->contains($id)) ? 'selected' : '' }}>{{ $program }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}"
                                      name="address" id="address">{{ old('address', $student->address) }}</textarea>
