    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="text-center mb-4">
                ...
                @else
                    <img src="/assets/images/university.png" class="img-thumbnail" alt="No Logo" style="max-width: 150px;">
                @endif
            ...
            <div class="form-group mt-4">
                <a class="btn btn-secondary" href="{{ route('student.university.show') }}">
