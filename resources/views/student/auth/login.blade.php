...
<div class="login-container">
    ...
    <div class="login-right">
        ...
        <p class="login-subtitle" style="text-align: center; margin-bottom: 20px;">Sign in to your student account</p>
        ...
        <form method="POST" action="{{ route('student.login') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="phone" id="phone" class="form-input" required placeholder="Enter your phone number">
