<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('setting_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/countries*") ? "c-show" : "" }} {{ request()->is("admin/states*") ? "c-show" : "" }} {{ request()->is("admin/cities*") ? "c-show" : "" }} {{ request()->is("admin/admission-stages*") ? "c-show" : "" }} {{ request()->is("admin/admission-statuses*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('admission_stage_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.admission-stages.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/admission-stages") || request()->is("admin/admission-stages/*") ? "c-active" : "" }}">
                    ...
                    @can('admission_status_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.admission-statuses.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/admission-statuses") || request()->is("admin/admission-statuses/*") ? "c-active" : "" }}">
        ...
        @endcan
        @can('university_manage_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/universities*") ? "c-show" : "" }} {{ request()->is("admin/programs*") ? "c-show" : "" }} {{ request()->is("admin/courses*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-university c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.universityManage.title') }}
                </a>
                <ul class="c-sidebar-nav-dropdown-items">
        ...
        @endcan
        @can('other_fee_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.other-fees.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/other-fees") || request()->is("admin/other-fees/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-dollar-sign c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.otherFee.title') }}
                </a>
            </li>
        @endcan
