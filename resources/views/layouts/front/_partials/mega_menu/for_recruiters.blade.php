<div class="mega-menu" id="Recruiters" data-title="For Recruiters"style="display: none;">
    ...
    <div class="mega-menu-right">
        <div>
            ...
            <a href="https://info.adventus.io/study-in-australia/">
                <div class="news-excerpt">We’ve created a dedicated resource hub so you can help your students
                    discover Australia - explore key information, from cost of living to visa guidance. Learn
                    more.</div>
            </a>
            <hr style="margin-top: 1em;">
        </div>
